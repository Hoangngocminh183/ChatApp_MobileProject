...
import com.example.chatapp_mobile.adapters.ChatAdapter;
        ...
        if (value != null) {
            ...
            for(DocumentChange documentChange : value.getDocumentChanges()){
                if(documentChange.getType() == DocumentChange.Type.ADDED) {
                    ...
                    chatMessage.dateTime = getReadableDateTime(new Date(documentChange.getDocument().getDate(Constants.KEY_TIMESTAMP).getTime()));
